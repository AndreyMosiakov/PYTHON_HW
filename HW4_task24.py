...
bush_count= int(input('введите кол-во кустов: '))
list_1 = [randint(1,10) for i in range(bush_count)]
print(list_1)
...
for i in range(bush_count):
    temp_sum = list_1[i] + list_1[i-1] + list_1[i+1]
    if temp_sum > max_sum:
        max_sum = temp_sum
        
    else:
        i+=1   
print(f'максимальное кол-во ягод, которое можно собрать за один заход : {max_sum}')    